...
Window = Fluent:CreateWindow({
    Title = "NHD TEAM HUB V1",
    SubTitle="By Synx [Freemium]", 
    TabWidth=155, 
    Theme="Light",
    Acrylic=false,
...
Info=Window:AddTab({ Title="Thông Tin" }),
    Main=Window:AddTab({ Title="Cày Chính" }),

Main1=Window:AddTab({ Title="Cày Khác" }),
    Sea=Window:AddTab({ Title="Sự Kiện Biển" }),
    Item=Window:AddTab({ Title="Stack Fram" }),
    Setting=Window:AddTab({ Title="Cài Đặt" }),
    Status=Window:AddTab({ Title="Trạng Thái 1" }),
    Stats=Window:AddTab({ Title="Trạng Thái 2" }),
    ...
    Race=Window:AddTab({ Title="Up Tộc" }),
...
for i,v in pairs(game.Workspace:GetChildren()) do
    pcall(function()
        if DevilFruitESP then
            if string.find(v.Name, "trái") then   
...
Button.Image = "rbxassetid://93035934325530"
...
local ToggleCollectBerry = Tabs.Main1:AddToggle("ToggleCollectBerry", {
    Title = "dịnh chuyển sever có bery",
    Description = "",
    Default = false
})
...
spawn(function()
  while wait() do
    ...
    local ToggleVatChatKiDi = Tabs.Main:AddToggle("ToggleVatChatKiDi", {
        Title="Auto Farm vật chất kì dị",
        Description="", 
        Default=false })
...
local ToggleTPKitsune = Tabs.Sea:AddToggle("ToggleTPKitsune", {Title = "dịch chuyển đảo kitsune", Description = "", Default = false})
...
if Sea3 then
    local ToggleHallow = Tabs.Item:AddToggle("ToggleHallow", {Title="Auto lưỡi hái",Description="", Default=false })
...
if Sea2 then
        local ToggleFactory = Tabs.Main1:AddToggle("ToggleFactory", {Title="Auto đánh nhà máy",Description="", Default=false })
...
local ToggleRandomFruit = Tabs.Fruit:AddToggle("ToggleRandomFruit", {Title="quay trái ác quỷ",Description="", Default=false })
...
local ToggleCollectTP = Tabs.Fruit:AddToggle("ToggleCollectTP", {Title="tự động nhặt trái",Description="", Default=false })
...
local ToggleEspFruit = Tabs.Fruit:AddToggle("ToggleEspFruit", {Title="trái ác quỷ",Description="", Default=false })
...
local ToggleBuy = Tabs.Raid:AddToggle("ToggleBuy", {Title="mua chip raid", Description="",Default=false })
...
local ToggleAwake = Tabs.Raid:AddToggle("ToggleAwake", {Title="không biết bạn tự hiểu",Description="", Default=false })
...
local Mastery = Tabs.Race:AddSection("up v4")
Tabs.Race:AddButton({
